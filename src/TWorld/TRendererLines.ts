 ...
 * @LastEditors: 贪玩的大橙子
 * @LastEditTime: 2024-05-12 10:58:01
 * @FilePath: TRendererLines.ts
 *
 * Copyright (c) 2024 by 贪玩的大橙子, All Rights Reserved.
 */
import { Camera, ColorRepresentation, Scene, WebGLRenderer, Renderer, PerspectiveCamera } from "three";
...
export class TRendererLines {
  ...
  public createRendererLines = () => {
    const { canvas, clearColor, scene, camera } = this.renderConfig;
